...
if args.variant == 'vanilla':
    ...
    model = model.GPT(mconf).to(device) # [part g] Make some other model here
else:
...
if args.function == 'pretrain':
    ...
    # num_workers=4
    # writer=writer 
    trainer_config = trainer.TrainerConfig(max_epochs=650, batch_size=128, learning_rate=6e-3,
    ...
    trainer = trainer.Trainer(model, pretrain_dataset, eval_dataset, trainer_config)
    trainer.train()
